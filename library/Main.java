...
*	that allow a user to borrow books, create an array of books and members for testing  
*	purposes, and most importantly, it contains the main method which starts the whole project.
*/
