...
public class TestListBookMethod  {
	...
	public static void main(String[] args) {
		...
		System.out.println("Testing listBooks() Method.");
		System.out.println("***************************************************");
		System.out.println("");
		System.out.println("The result should be the array with details like ID, author, title, call number");
		System.out.println("");
		
		System.out.println("Output: "+bookMapDAO.listBooks());
	}
