...
public class TestFindBookByAuthorException {
	...
	public static void main(String[] args) {
		...
		System.out.println("***************************************************");
		System.out.println("");
		System.out.println("The result should be blank array because such author name is not existing in the given list");
		System.out.println("");
		System.out.println("Output: "+bookMapDAO.findBooksByAuthor("Ramanpreet"));
	}
