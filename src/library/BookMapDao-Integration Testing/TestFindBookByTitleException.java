...
public class TestFindBookByTitleException {
	...
	public static void main(String[] args) {
		...
		System.out.println("Testing findBooksByTitle() Method.");
		System.out.println("***************************************************");
		System.out.println("");
		System.out.println("The result should be blank array because because such book title is not existing in the given list");
		System.out.println("");
		
		System.out.println("Output: "+bookMapDAO.findBooksByTitle("Professional Programming Practice"));
	}
