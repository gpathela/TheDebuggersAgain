...
public class TestFindBookByAuthorTitleException {
	...
	public static void main(String[] args) {
		...
		//Testing findBooksByAuthorTitle() Method
		System.out.println("Testing findBooksByAuthorTitle() Method.");
		System.out.println("***************************************************");
		System.out.println("");
		System.out.println("The result should be blank array because we tried the non existing information");
		System.out.println("");
		System.out.println("Output: "+bookMapDAO.findBooksByAuthorTitle("Ramanpreet","The Tale of Peter Rabbit"));
	}
