...
public class TestFindBookByIdException {
	...
	public static void main(String[] args) {
		...
		//Testing getBookByID() Method
		System.out.println("Testing getBookByID() Method.");
		System.out.println("***************************************************");
		System.out.println("");
		System.out.println("The result should be null because because this ID is not existing in the given list");
		System.out.println("");
		
		System.out.println("Output: "+bookMapDAO.getBookByID(5));
	}
