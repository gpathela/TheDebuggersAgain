...
*/
public class TestFindOverDueLoans {
	...
	public static void main(String[] args) {
		...
		//Test to find over due Loans
		System.out.println("Test to find overdue Loans");
		System.out.println("Output should be empty array as no book is overdue yet");
		System.out.println(testLoanMapDAO.findOverDueLoans());
