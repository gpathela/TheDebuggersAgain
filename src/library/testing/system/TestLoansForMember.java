...
*/
public class TestLoansForMember {
	...
	public static void main(String[] args) {
		...
		//Test to find loan for the member. 
		System.out.println("Test to check loan for the member.");
		System.out.println("Result should be details like Book: 'testAuthor' etc");
		System.out.println(testMember.getLoans());
	}
}