...
*/
public class TestLoansByBorrower {
	...
	public static void main(String[] args) {
		...
		//Test to find loans by a borrower
		System.out.println("Test to find loans by member");
		System.out.println("Given 'testMember' as input");
		System.out.println("Output should be book details and issue and return date");
		System.out.println(testLoanMapDAO.findLoansByBorrower(testMember));
